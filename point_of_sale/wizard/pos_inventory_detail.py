...
class PosInventoryDetails(models.TransientModel):
    _name = 'pos.inventory.wizard'
    _description = 'Open Inventory Details Report'
    ...
    pos_config_ids = fields.Many2many('pos.config', 'pos_inventory_configs',
    ...
    def generate_report(self):
        ...
        return self.env['report'].get_action(
            [], 'point_of_sale.report_inventory_details', data=data)
